...
/***
 * This is from Tinymvc which is easy implementation --Gefferey Zhang
 * Name:       TinyMVC
...
class Db_Pdo {
	...
	function __construct($config) {
		...
		try {
			$this->pdo = new PDO ( $dsn, $config ['user'], $config ['pass'], array (PDO::ATTR_PERSISTENT => ! empty ( $config ['persistent'] ) ? true : false ) );
